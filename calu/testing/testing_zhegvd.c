...
int testing_zhegvd(int argc, char **argv)
{
    ...
    PLASMA_Alloc_Workspace_zhegvd(N, N, &T);
    ...
    */
    ...
    printf("\n");
    printf("------ TESTS FOR PLASMA ZHEGVD ROUTINE -------  \n");
    ...
    for (i=0; i<3; i++) {
        for (u=0; u<2; u++) {
            ...
            /* CALL ZHEGVD with itype= 1, 2, 3 and uplo= L,U */ 
            PLASMA_zhegvd(itype[i], vec, uplo[u], N, A2, LDA, B2, LDB, W2, T, Q, LDQ);
            ...
            LAPACKE_zhegvd( LAPACK_COL_MAJOR, 
            ...
            if ( (info_ortho == 0) & (info_reduction == 0) & (info_solution == 0)) {
                printf("***************************************************\n");
                printf(" ---- TESTING ZHEGVD (%s, %s) ...................... PASSED !\n", itypestr[i], uplostr[u]);
                printf("***************************************************\n");
            }
            else {
                printf("************************************************\n");
                printf(" - TESTING ZHEGVD (%s, %s) ... FAILED !\n", itypestr[i], uplostr[u]);
                printf("************************************************\n");
            } 
        }
    }
                           ...
                           double eps )
{
    ...
    Anorm = LAPACKE_zlanhe_work(LAPACK_COL_MAJOR, lapack_const(PlasmaOneNorm), N, N, A,        LDA, work);
