...
*     .. Local Scalars ..
     ...
     $                   NFAIL, NIMAT, NRHS, NRUN, PLASMA_UPLO
...
*
                  ...
                  SRNAMT = 'ZPOTRF'
                  CALL PLASMA_ZPOTRF( PLASMA_UPLO, N, AFAC, LDA, INFO )
*
...
*
                  CALL ZLACPY( UPLO, N, N, AFAC, LDA, AINV, LDA )
                  SRNAMT = 'ZPOTRI'
                  CALL PLASMA_ZPOTRI( PLASMA_UPLO, N, AINV, LDA, 
     $                 INFO )
*
...
*
                     SRNAMT = 'ZPOTRS'
                     CALL PLASMA_ZPOTRS( PLASMA_UPLO, N, NRHS, AFAC, 
     $                                   LDA, X, LDA, INFO )
*
