...
*  =======
*
*  DCHKAA is the main test program for the DOUBLE PRECISION PLASMA
...
*  following 36 lines:
*  Data file for testing DOUBLE PRECISION PLASMA linear eqn. routines
...
*
 ...
 9995 FORMAT( ' Invalid input value: ', A4, '=', I6, '; must be <=',
     $      I6 )
 9994 FORMAT( ' Tests of the DOUBLE PRECISION PLASMA routines ',
