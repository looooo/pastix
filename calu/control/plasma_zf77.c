...
void PLASMA_ZLANGE_TILE_ASYNC(PLASMA_enum *norm, PLASMA_desc *A, double *value, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_zlange_Tile_Async(*norm, A, value, sequence, request); }

#ifdef COMPLEX
void PLASMA_ZLANHE_TILE_ASYNC(PLASMA_enum *norm, PLASMA_enum *uplo, PLASMA_desc *A, double *value, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_zlanhe_Tile_Async(*norm, *uplo, A, value, sequence, request); }
#endif

void PLASMA_ZLANSY_TILE_ASYNC(PLASMA_enum *norm, PLASMA_enum *uplo, PLASMA_desc *A, double *value, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_zlansy_Tile_Async(*norm, *uplo, A, value, sequence, request); }
