...
void PLASMA_ZGEBRD(int *M, int *N, PLASMA_Complex64_t *A, int *LDA, double *D, double *E, PLASMA_desc **descT, int *info)
{ *info = PLASMA_zgebrd(*M, *N, A, *LDA, D, E, *descT); }
...
void PLASMA_ZGESVD(PLASMA_enum *jobu, PLASMA_enum *jobvt, int *M, int *N, PLASMA_Complex64_t *A, int *LDA, double *S, PLASMA_Complex64_t *U, int *LDU, PLASMA_Complex64_t *VT, int *LDVT, PLASMA_desc **descT, int *info)
{ *info = PLASMA_zgesvd(*jobu, *jobvt, *M, *N, A, *LDA, S, U, *LDU, VT, *LDVT, *descT); }
...
void PLASMA_ZGETRS_INCPIV(PLASMA_enum *trans, int *N, int *NRHS, PLASMA_Complex64_t *A, int *LDA, PLASMA_desc **descL, int *IPIV, PLASMA_Complex64_t *B, int *LDB, int *info)
...
void PLASMA_ZLANGE(PLASMA_enum *norm, int *M, int *N, PLASMA_Complex64_t *A, int *LDA, double *work, double *result)
{ *result = PLASMA_zlange(*norm, *M, *N, A, *LDA, work); }

#ifdef COMPLEX
void PLASMA_ZLANHE(PLASMA_enum *norm, PLASMA_enum *uplo, int *N, PLASMA_Complex64_t *A, int *LDA, double *work, double *result)
{ *result = PLASMA_zlanhe(*norm, *uplo, *N, A, *LDA, work); }
#endif

void PLASMA_ZLANSY(PLASMA_enum *norm, PLASMA_enum *uplo, int *N, PLASMA_Complex64_t *A, int *LDA, double *work, double *result)
{ *result = PLASMA_zlansy(*norm, *uplo, *N, A, *LDA, work); }
...
void PLASMA_ZLASWP(int *N, PLASMA_Complex64_t *A, int *LDA, int *K1, int *K2, int *IPIV, int *INCX, int *info)
{ *info = PLASMA_zlaswp(*N, A, *LDA, *K1, *K2, IPIV, *INCX); }

void PLASMA_ZLASWPC(int *N, PLASMA_Complex64_t *A, int *LDA, int *K1, int *K2, int *IPIV, int *INCX, int *info)
...
void PLASMA_ZTRSMPL(int *N, int *NRHS, PLASMA_Complex64_t *A, int *LDA, PLASMA_desc **descL, int *IPIV, PLASMA_Complex64_t *B, int *LDB, int *info)
 ...
 *  FORTRAN API - math functions (native interface)
 **/
void PLASMA_ZGEBRD_TILE(PLASMA_desc *A, double *D, double *E, PLASMA_desc *T, int *info)
{ *info = PLASMA_zgebrd_Tile(A, D, E, T); }
...
void PLASMA_ZGESVD_TILE(PLASMA_enum *jobu, PLASMA_enum *jobvt, PLASMA_desc *A, double *S, PLASMA_desc *U, PLASMA_desc *VT, PLASMA_desc *T, int *info)
{ *info = PLASMA_zgesvd_Tile(*jobu, *jobvt, A, S, U, VT, T); }
...
void PLASMA_ZGETRS_TILE(PLASMA_enum *trans, PLASMA_desc *A, int *IPIV, PLASMA_desc *B, int *info)
{ *info = PLASMA_zgetrs_Tile(*trans, A, IPIV, B); }

void PLASMA_ZGETRS_INCPIV_TILE(PLASMA_desc *A, PLASMA_desc *L, int *IPIV, PLASMA_desc *B, int *info)
...
void PLASMA_ZLANGE_TILE(PLASMA_enum *norm, PLASMA_desc *A, double *work, double *result)
{ *result = PLASMA_zlange_Tile(*norm, A, work); }

#ifdef COMPLEX
void PLASMA_ZLANHE_TILE(PLASMA_enum *norm, PLASMA_enum *uplo, PLASMA_desc *A, double *work, double *result)
{ *result = PLASMA_zlanhe_Tile(*norm, *uplo, A, work); }
#endif

void PLASMA_ZLANSY_TILE(PLASMA_enum *norm, PLASMA_enum *uplo, PLASMA_desc *A, double *work, double *result)
{ *result = PLASMA_zlansy_Tile(*norm, *uplo, A, work); }
...
void PLASMA_ZLASWP_TILE(PLASMA_desc *A, int *K1, int *K2, int *IPIV, int *INCX, int *info)
{ *info = PLASMA_zlaswp_Tile(A, *K1, *K2, IPIV, *INCX); }

void PLASMA_ZLASWPC_TILE(PLASMA_desc *A, int *K1, int *K2, int *IPIV, int *INCX, int *info)
...
void PLASMA_ZTRSMPL_TILE(PLASMA_desc *A, PLASMA_desc *L, int *IPIV, PLASMA_desc *B, int *info)
 ...
 *  FORTRAN API - math functions (asynchronous interface)
 **/
void PLASMA_ZGEBRD_TILE_ASYNC(PLASMA_desc *A, double *D, double *E, PLASMA_desc *T, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_zgebrd_Tile_Async(A, D, E, T, sequence, request); }
...
void PLASMA_ZGESVD_TILE_ASYNC(PLASMA_enum *jobu, PLASMA_enum *jobvt, PLASMA_desc *A, double *S, PLASMA_desc *U, PLASMA_desc *VT, PLASMA_desc *T, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_zgesvd_Tile_Async(*jobu, *jobvt, A, S, U, VT, T, sequence, request); }
...
void PLASMA_ZGETRS_TILE_ASYNC(PLASMA_enum *trans, PLASMA_desc *A, int *IPIV, PLASMA_desc *B, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_zgetrs_Tile_Async(*trans, A, IPIV, B, sequence, request); }

void PLASMA_ZGETRS_INCPIV_TILE_ASYNC(PLASMA_desc *A, PLASMA_desc *L, int *IPIV, PLASMA_desc *B, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
...
void PLASMA_ZLANGE_TILE_ASYNC(PLASMA_enum *norm, PLASMA_desc *A, double *work, double *value, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_zlange_Tile_Async(*norm, A, work, value, sequence, request); }

#ifdef COMPLEX
void PLASMA_ZLANHE_TILE_ASYNC(PLASMA_enum *norm, PLASMA_enum *uplo, PLASMA_desc *A, double *work, double *value, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_zlanhe_Tile_Async(*norm, *uplo, A, work, value, sequence, request); }
#endif

void PLASMA_ZLANSY_TILE_ASYNC(PLASMA_enum *norm, PLASMA_enum *uplo, PLASMA_desc *A, double *work, double *value, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_zlansy_Tile_Async(*norm, *uplo, A, work, value, sequence, request); }
...
void PLASMA_ZLASWP_TILE_ASYNC(PLASMA_desc *A, int *K1, int *K2, int *IPIV, int *INCX, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
{ *info = PLASMA_zlaswp_Tile_Async(A, *K1, *K2, IPIV, *INCX, sequence, request); }

void PLASMA_ZLASWPC_TILE_ASYNC(PLASMA_desc *A, int *K1, int *K2, int *IPIV, int *INCX, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
...
void PLASMA_ZTRSMPL_TILE_ASYNC(PLASMA_desc *A, PLASMA_desc *L, int *IPIV, PLASMA_desc *B, PLASMA_sequence *sequence, PLASMA_request *request, int *info)
