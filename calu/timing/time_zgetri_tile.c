...
static int check_getri_factorization(PLASMA_desc *descA1, PLASMA_desc *descA2, int *IPIV)
{
    ...
    Xnorm = PLASMA_zlange_Tile(PlasmaInfNorm, descX,  work);
    Anorm = PLASMA_zlange_Tile(PlasmaInfNorm, descA1, work);
    Bnorm = PLASMA_zlange_Tile(PlasmaInfNorm, descB,  work);

    PLASMA_zgemm_Tile( PlasmaNoTrans, PlasmaNoTrans,
                       (PLASMA_Complex64_t)1.,  descA1, descX, 
                       (PLASMA_Complex64_t)-1., descB);
    
    Rnorm = PLASMA_zlange_Tile(PlasmaInfNorm, descB, work);
...
static int check_getri_inverse(PLASMA_desc *descA1, PLASMA_desc *descA2, int *IPIV, double *dparam )
{
    ...
    Anorm    = PLASMA_zlange_Tile(PlasmaInfNorm, descA1, W);
    Ainvnorm = PLASMA_zlange_Tile(PlasmaInfNorm, descA2, W);
    Rnorm    = PLASMA_zlange_Tile(PlasmaInfNorm, descW,  W);
