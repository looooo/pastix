 ...
 *
 *  CORE_zhbtype2cb is a kernel that will operate on a region
 *  (triangle) of data bounded by st and ed. This kernel apply the
 *  right update remaining from the type1 and this later will create a
 *  bulge so it eliminate the first column of the created bulge and do
 *  the corresponding Left update.
