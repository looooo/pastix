 ...
 *
 *  CORE_zhbtype3cb is a kernel that will operate on a region
 *  (triangle) of data bounded by st and ed. This kernel apply a
 *  left+right update on the hermitian triangle.  Note that this
 *  kernel is very similar to type1 but does not do an elimination.
