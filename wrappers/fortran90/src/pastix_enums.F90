...
module pastix_enums
  ...
  enum, bind(C)
     ...
     enumerator :: IPARM_ALLCAND               = 34
     enumerator :: IPARM_INCOMPLETE            = 35
     enumerator :: IPARM_LEVEL_OF_FILL         = 36
     enumerator :: IPARM_FACTORIZATION         = 37
     enumerator :: IPARM_STATIC_PIVOTING       = 38
     enumerator :: IPARM_FREE_CSCUSER          = 39
     enumerator :: IPARM_SCHUR_FACT_MODE       = 40
     enumerator :: IPARM_SCHUR_SOLV_MODE       = 41
     enumerator :: IPARM_APPLYPERM_WS          = 42
     enumerator :: IPARM_REFINEMENT            = 43
     enumerator :: IPARM_NBITER                = 44
     enumerator :: IPARM_ITERMAX               = 45
     enumerator :: IPARM_GMRES_IM              = 46
     enumerator :: IPARM_SCHEDULER             = 47
     enumerator :: IPARM_THREAD_NBR            = 48
     enumerator :: IPARM_AUTOSPLIT_COMM        = 49
     enumerator :: IPARM_GPU_NBR               = 50
     enumerator :: IPARM_GPU_MEMORY_PERCENTAGE = 51
     enumerator :: IPARM_GPU_MEMORY_BLOCK_SIZE = 52
     enumerator :: IPARM_COMPRESS_MIN_WIDTH    = 53
     enumerator :: IPARM_COMPRESS_MIN_HEIGHT   = 54
     enumerator :: IPARM_COMPRESS_WHEN         = 55
     enumerator :: IPARM_COMPRESS_METHOD       = 56
     enumerator :: IPARM_COMPRESS_ORTHO        = 57
