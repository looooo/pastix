...
{
    dague_zgetrf_sp2d_handle_t *dague_zgetrf_sp = NULL;

    dague_zgetrf_sp = dague_zgetrf_sp2d_new( (dague_ddesc_t*)A, sopalin_data, NULL );
    ...
    dague_matrix_add2arena_rect( dague_zgetrf_sp->arenas[DAGUE_zgetrf_sp2d_DEFAULT_ARENA],
...
{
    dague_zgetrf_sp2d_handle_t *dague_zgetrf_sp = NULL;
    dague_zgetrf_sp = (dague_zgetrf_sp2d_handle_t *)handle;

    dague_matrix_del2arena( dague_zgetrf_sp->arenas[DAGUE_zgetrf_sp2d_DEFAULT_ARENA] );
