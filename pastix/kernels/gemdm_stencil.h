...
#ifndef _GEMDM_STENCIL_H_
#define _GEMDM_STENCIL_H_
...
#define fetch2(A, n)    tex_fetch(tex_ref_##A, coord_##A + n*LD##A)
#else
#define fetch(A, m, n) offs_d##A[n*LD##A+m]
#define fetch2(A, n)   offs_d##A[n*LD##A]
#endif
...
texture<int4, 1, cudaReadModeElementType> tex_ref_D;
...
texture<float2, 1, cudaReadModeElementType> tex_ref_D;
...
texture<int2, 1, cudaReadModeElementType> tex_ref_D;
...
texture<float, 1, cudaReadModeElementType> tex_ref_D;
