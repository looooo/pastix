...
#                         reserved.
#
#  Internal: generation of various floating point precision files from a template.
#
...
macro(precisions_rules_py)
  ...
  CDR(__SOURCES ${PREC_RULE_DEFAULT_ARGS})
  ...
  foreach(_dependency ${dependencies_list})
    ...
    if( not_empty )
      ...
      if( NOT PROJECT_COMPILE_INPLACE )
        set(generate_out 1)
      else( NOT PROJECT_COMPILE_INPLACE )
