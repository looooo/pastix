...
void starpu_zpotrfsp1d_geadd_cpu(void * buffers[], void * _args);
...
void starpu_zsytrfsp1d_geadd_cpu(void * buffers[], void * _args);
...
void starpu_zhetrfsp1d_geadd_cpu(void * buffers[], void * _args);
