             ...
             pastix_complex64_t **rhs)
{
  ...
  *RhsType = (char *) malloc(4*sizeof(char));
  ...
  z_chbReadHeader(infile, *Type, Nrow, Ncol, Nnzero, &Nrhs, Ptrfmt, Indfmt, Valfmt, Rhsfmt,
...
#else
                  (*val)[(count-1)/2] += (pastix_complex64_t)atof(element)*I;
#endif
#endif
                }
              else
                {
                  (*val)[count/2] = (pastix_complex64_t)atof(element);
                }
            }
          else
            {
              (*val)[count] = (pastix_complex64_t)atof(element);
            }
...
#else
                      (*rhs)[(count-1)/2] += (pastix_complex64_t)atof(element)*I;
#endif
#endif
                    }
                  else
                    {
                      (*rhs)[count/2] = (pastix_complex64_t)atof(element);
                    }
                }
              else
                {
                  (*rhs)[count] = (pastix_complex64_t)atof(element);
                }
...
#else
                          rhs2[(count-1)/2] += (pastix_complex64_t)atof(element)*I;
#endif
#endif
                        }
                      else
                        {
                          rhs2[count/2] = (pastix_complex64_t)atof(element);
                        }
                    }
                  else
                    {
                      rhs2[count] = (pastix_complex64_t)atof(element);
                    }
