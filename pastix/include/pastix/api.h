...
enum IPARM_ACCESS {
  ...
  IPARM_METIS_NO2HOP            = 73,
  IPARM_METIS_NSEPS             = 74,
  IPARM_METIS_NITER             = 75,
  IPARM_METIS_UFACTOR           = 76,
  IPARM_METIS_COMPRESS          = 77,
  IPARM_METIS_CCORDER           = 78,
  IPARM_METIS_PFACTOR           = 79,
  IPARM_METIS_SEED              = 80,
