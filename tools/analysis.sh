...
cppcheck -v -f --language=c --platform=unix64 --enable=all --xml --xml-version=2 --suppress=missingInclude ${UNDEFINITIONS} --project=${BUILDDIR}/compile_commands.json 2> pastix-cppcheck.xml
