            ...
            pastix_int_t ldwork )
{
    ...
    if ( A->rk != -1 ) {
         ...
         */
            ...
            stop_trace_kernel( 2, FLOPS_ZGEMM( A->rk, N, K ) );
        }
    }
    else {
        /**
        ...
        if ( B->rk != -1 ) {
            ...
            stop_trace_kernel( 2, FLOPS_ZGEMM( M, B->rk, K ) );
            ...
            pastix_lrblock_t *AB )
{
    ...
    stop_trace_kernel( 2, FLOPS_ZGEMM( A->rk, B->rk, K ) );
            ...
            SolverCblk *fcblk )
{
    ...
    if (C->rk == -1) {
        ...
        if ( AB.rk == -1 ) {
            ...
            stop_trace_kernel( 2, FLOPS_ZGEMM( M, N, AB.rk ) );
        }
    }
     /**
        ...
        if ( AB.rk == -1 ) {
            ...
            if ( AB.rk + C->rk > pastix_imin(M, N) ) {
                ...
                if (C->rk > 0){
                    ...
                    stop_trace_kernel( 2, FLOPS_ZGEMM( Cm, Cn, C->rk ) );
                }
                else{
