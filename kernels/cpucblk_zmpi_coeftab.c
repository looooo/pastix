 ...
 *******************************************************************************
 *
 * @return size of the LR cblk to send in bytes.
 *
 *******************************************************************************/
pastix_uint_t
 ...
 *******************************************************************************
 *
 * @brief Pack a low-rank cblk data.
 *
 *******************************************************************************
 *
 * @param[in] side
 ...
 *******************************************************************************
 *
 * @return Pointer to the next data to unpack.
 *
 *******************************************************************************/
char *
 ...
 *******************************************************************************
 *
 * @brief Unpack a low-rank column block and fill the cblk concerned by the computation.
 *
 *******************************************************************************
 *
 * @param[in] side
