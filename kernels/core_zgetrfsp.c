                              ...
                              pastix_complex64_t *work )
{
    ...
    for (iterblok=blok; iterblok<lblok; iterblok++) {
        ...
        if (fblok->coefind + iterblok->frownum - fblok->frownum < stride_D){
            ...
            if (blok->rankU != -1){
                ...
                core_z_uncompress_LR(Akj, cblk->stride,
                                     dimb, dima,
                                     u, dimb,
                                     v, dima,
                                     blok->rankU);
            ...
            if (iterblok->rankL != -1){
                ...
                core_z_uncompress_LR(Aik, cblk->stride,
                                     dimb, dima,
                                     u, dimb,
                                     v, dima,
                                     iterblok->rankL);
            ...
            if (rankL != -1 && rankU != -1 && rankF != -1){
                ...
                if (ret == -1){
                    ...
                    if (fblok->rankL != -1){
                        ...
                        core_z_uncompress_LR(Aij, stridefc,
                                             sizeF, stride_D,
                                             uF, sizeF,
                                             vF, stride_D,
                                             fblok->rankL);
    ...
    for (; iterblok<lblok; iterblok++) {
        ...
        /* Each blok is LR */
        if (rankL != -1 && rankU != -1 && rankF != -1 && 0){
            printf("\n\nNEW LR + LR on U not managed yet\n\n");
        }
            ...
            if (ret == -1){
                ...
                if (fblok->rankU != -1){
                    ...
                    core_z_uncompress_LR(Aij, fcblk->stride,
                                         dimb, dima,
                                         u, dimb,
                                         v, dima,
                                         fblok->rankU);
