 ...
 *******************************************************************************
 *
 * @brief Perform the LU factorization of a given panel and submit tasks for the
 * subsequent updates.
 *
 *******************************************************************************
 *
 ...
 *******************************************************************************
 *
 * @brief Apply the updates of the LU factorisation of a given panel.
 *
 *******************************************************************************
 *
 * @param[in] solvmtx
                               ...
                               pastix_int_t        lwork )
{
    ...
    if ( fcbk->cblktype & CBLK_FANIN ) {
        cpucblk_zalloc( PastixLUCoef, fcbk );
    }
    ...
    do
    {
        ...
        if ( blok+1 < lblk ) {
            cpucblk_zgemmsp( PastixUCoef, PastixTrans,
                             cblk, blok, fcbk,
                             U, L, cblk_getdataU( fcbk ),
                             work, lwork, &(solvmtx->lowrank) );
        }
        cpucblk_zrelease_deps( PastixLUCoef, solvmtx, cblk, fcbk );
        blok++;
    }
    while ( ( blok < lblk ) &&
