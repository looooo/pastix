...
typedef enum pastix_iparm_e {
    ...
    IPARM_2DTASKS_LEVEL,         /**< 2D Distribution level (-1 for autolevel, 0 for 1D)             Default: -1                       IN    */
    IPARM_2DTASKS_WIDTH,         /**< Minimal width for 2D tasks with autolevel                      Default: IPARM_MIN_BLOCKSIZE      IN    */
