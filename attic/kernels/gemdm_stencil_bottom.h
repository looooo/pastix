...
#ifndef _GEMDM_STENCIL_BOTTOM_H_
#define _GEMDM_STENCIL_BOTTOM_H_
...
static __device__
cuDoubleComplex tex_fetch(texture<int4> tex_ref, int coord)
{
...
static __device__
cuDoubleComplex tex_fetch(texture<float2> tex_ref, int coord)
{
...
static __device__
cuDoubleComplex tex_fetch(texture<int2> tex_ref, int coord)
{
...
static __device__
cuDoubleComplex tex_fetch(texture<float> tex_ref, int coord)
{
    return tex1Dfetch(tex_ref, coord);
}
...
#include "gemdm_stencil_bottom.cu"
...
#endif /* _GEMDM_STENCIL_BOTTOM_H_ */
